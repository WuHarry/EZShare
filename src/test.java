...
public class test {
    public static void main(String[] args){
        ...
        System.out.println("Resource description = " + newCommand.getResourceDescription());
        System.out.println("Resource uri = " + newCommand.getResourceUri());
        System.out.println("Resource channel = " + newCommand.getResourceChannel());
        System.out.println("Resource owner = " + newCommand.getResourceOwner());
        System.out.println("Resource Ezserver = " + newCommand.getResourceEZserver());
